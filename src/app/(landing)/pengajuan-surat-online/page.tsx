            ...
            <div className="container">
                        ...
                        <div className="jumbotron-schedule">
                            <ul className="schedule-list">
                                <li className="schedule-item">
                                    <Icon name="CalendarIcon" className="schedule-icon" />
                                    <span className="schedule-text">Jadwal Buka Surat Online</span>
                                </li>
                                <li className="schedule-item">
                                    <Icon name="CheckIcon" className="schedule-icon" />
                        ...
                        <div className="jumbotron-timeline">
                            <ul className="timeline-list">
                                ...
                                <li className="timeline-item">
                                    <Icon name='MinusIcon' className="timeline-icon" />
                ...
                <section id="information">
                    <div className="information-content">
                        <Icon name="InformationCircleIcon" className="information-icon"/>
                        <span>
