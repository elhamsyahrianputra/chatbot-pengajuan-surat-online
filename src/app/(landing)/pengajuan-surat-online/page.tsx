      ...
      <div className="container">
        <section id="jumbotron">
          ...
          <div className="jumbotron-content">
            <div className="jumbotron-schedule">
              <ul className="schedule-list">
                ...
                <li className="schedule-item">
                  <FontAwesomeIcon icon={faCheck} className="schedule-icon" />
                  <span className="schedule-text">
                    TUTUP Sabtu, Minggu & Libur Nasional
                  </span>
                </li>
              </ul>
            </div>
            <div className="jumbotron-illustration">
              <Image
                src="/img/illustration/pengajuan-surat-online-illustration.svg"
                alt="Pengajuan Surat Online Illustration"
                width={374}
                height={242}
              />
            </div>
              ...
              <ul className="timeline-list">
                ...
                <li className="timeline-item">
                  ...
                  <span className="timeline-text">
                    08.00 - 11.00 : Form dibuka
                  </span>
                </li>
                <li className="timeline-item">
                  <FontAwesomeIcon icon={faMinus} className="timeline-icon" />
                  <span className="timeline-text">
                    11.00 - 14.00 : Verifikasi surat ajuan
                  </span>
                </li>
                <li className="timeline-item">
                  <FontAwesomeIcon icon={faMinus} className="timeline-icon" />
                  <span className="timeline-text">
                    14.00 - 15.00 : Pemberian Nomor Surat, Tanda tangan dan Cap
                    digital
                  </span>
                </li>
                <li className="timeline-item">
                  <FontAwesomeIcon icon={faMinus} className="timeline-icon" />
                  <span className="timeline-text">
                    15.00 - 15.30 : Pengiriman surat melalui email terdaftar
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section id="information">
          <div className="information-content">
            ...
            />
            <span>
              Pengajuan Perpanjangan, Penundaan, Cuti dibuka setiap hari dan jam
              kerja mulai <strong>Pkl. 08.00 - 15.00 WIB</strong>
            </span>
          </div>
        </section>
          ...
          <ul className="category-list">
            {letterTypes.map((item) => (
              <CategoryItem
                key={item.id}
                title={item.name}
                href={item.requirements?.length === 0 
                  ? "#" 
                  : `/pengajuan-surat-online/${item.slug}`}                
              />
            ))}
          </ul>
        </section>
