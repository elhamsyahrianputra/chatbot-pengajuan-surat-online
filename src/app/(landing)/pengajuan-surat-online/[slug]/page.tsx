    ...
    return (
        <main id="jenis-surat">
            <div className="container">
                <Link href="/pengajuan-surat-online" className="back-to-letter-types">
                ...
                <section id="note-section">
                    ...
                    <ul className="note-list">
                        ...
                        <li className="note-item">
                            <p className="note-text">
                                Pengajuan Surat akan segera diproses dan diverifikasi, jika telah selesai, surat akan dikirimkan melalui email, mohon untuk selalu mengecek di{" "}
                                <b>Inbox reguler/SPAM email</b>
                            </p>
                        </li>
                    </ul>
                </section>
